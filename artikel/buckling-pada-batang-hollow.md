---
article_id: HP-07-02
title: "Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup"
slug: "buckling-pada-batang-hollow"
description: "Menjelaskan global/local buckling concepts, length/restraint, imperfections, section class concept, and warning signs"
status: outline
publication_date: "2025-11-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: HP-07
primary_intent: "Memahami failure concept"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/buckling-pada-batang-hollow.html"
...
# Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup”
- **Reader and situation:** Pembaca menilai kolom/strut secara intuitif
- **Reader outcome:** Menjelaskan global/local buckling concepts, length/restraint, imperfections, section class concept, and warning signs
- **Primary intent:** Memahami failure concept
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak memberi allowable load atau member selection; engineer and governing code own values
- **Final public route:** `/artikel/buckling-pada-batang-hollow.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup**.
...
- `/jual-hollow-hitam-batang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-hitam-batang-hari.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-hitam-batang-hari` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-hitam-batang` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-galvanis-batang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-galvanis-batang-hari.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup”.

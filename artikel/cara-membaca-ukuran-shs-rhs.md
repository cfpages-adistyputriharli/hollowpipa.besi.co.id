---
article_id: HP-03-04
title: "Cara Membaca Ukuran SHS dan RHS: Sisi, Tebal, Radius Sudut, dan Panjang"
slug: "cara-membaca-ukuran-shs-rhs"
description: "Menjelaskan urutan dimensi, radius sudut, panjang, massa nominal, dan titik ukur lapangan"
status: outline
publication_date: "2025-08-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: HP-03
primary_intent: "Membaca dimensi hollow"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/cara-membaca-ukuran-shs-rhs.html"
...
# Cara Membaca Ukuran SHS dan RHS: Sisi, Tebal, Radius Sudut, dan Panjang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Membaca Ukuran SHS dan RHS: Sisi, Tebal, Radius Sudut, dan Panjang”
- **Reader and situation:** Pembeli/fabricator memeriksa notasi hollow
- **Reader outcome:** Menjelaskan urutan dimensi, radius sudut, panjang, massa nominal, dan titik ukur lapangan
- **Primary intent:** Membaca dimensi hollow
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak menilai toleransi penerimaan atau kapasitas; HP-03-05 dan HP-07-01 memilikinya
- **Final public route:** `/artikel/cara-membaca-ukuran-shs-rhs.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Membaca Ukuran SHS dan RHS: Sisi, Tebal, Radius Sudut, dan Panjang**.
...
- `/jual-hollow-hitam-padang-panjang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-hitam-padang-panjang` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-galvanis-padang-panjang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-hollow-galvanis-padang-panjang` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `HP-03-02` → `/artikel/kalkulator-berat-teoritis-hollow-dan-pipa.html` — Kalkulator Berat Teoritis Hollow dan Pipa: Rumus, Asumsi, dan Selisih Nyata
- `HP-03-03` → `/artikel/apa-itu-pipe-schedule.html` — Apa Itu Pipe Schedule? Mengapa Nomor Schedule Bukan Tebal dalam Milimeter
- `HP-03-05` → `/artikel/toleransi-dimensi-hollow-dan-pipa.html` — Toleransi Hollow dan Pipa: Mana yang Diukur dan Mengapa Angka Katalog Bisa Berbeda
- `HP-03-06` → `/artikel/menghitung-batang-pola-potong-dan-waste.html` — Menghitung Jumlah Batang, Pola Potong, dan Waste untuk Hollow atau Pipa
...
- **Tie back to this article:** Keep the explanation specific to “Cara Membaca Ukuran SHS dan RHS: Sisi, Tebal, Radius Sudut, dan Panjang”.

---
article_id: HP-15-01
title: "BOQ Hollow dan Pipa yang Bisa Ditenderkan: Kolom Data yang Sering Hilang"
slug: "boq-hollow-dan-pipa"
description: "Provides fields for item/function, specification, dimensions, length/quantity, fabrication, finish, testing, documents, delivery, wastage, and substitution"
status: outline
publication_date: "2026-06-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: HP-15
primary_intent: "Create procurement quantity/spec"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/boq-hollow-dan-pipa.html"
...
# BOQ Hollow dan Pipa yang Bisa Ditenderkan: Kolom Data yang Sering Hilang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “BOQ Hollow dan Pipa yang Bisa Ditenderkan: Kolom Data yang Sering Hilang”
- **Reader and situation:** Estimator/procurement prepares RFQ
- **Reader outcome:** Provides fields for item/function, specification, dimensions, length/quantity, fabrication, finish, testing, documents, delivery, wastage, and substitution
- **Primary intent:** Create procurement quantity/spec
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak chooses grade or calculates design quantity; HP-05-06 owns requirement selection and designer owns takeoff basis
- **Final public route:** `/artikel/boq-hollow-dan-pipa.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **BOQ Hollow dan Pipa yang Bisa Ditenderkan: Kolom Data yang Sering Hilang**.
...
- **Tie back to this article:** Keep the explanation specific to “BOQ Hollow dan Pipa yang Bisa Ditenderkan: Kolom Data yang Sering Hilang”.

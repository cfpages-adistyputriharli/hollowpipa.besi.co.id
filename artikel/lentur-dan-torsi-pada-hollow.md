---
article_id: HP-07-03
title: "Lentur dan Torsi pada Hollow: Memahami Arah Kuat, Bentuk, dan Jalur Beban"
slug: "lentur-dan-torsi-pada-hollow"
description: "Menjelaskan principal axes, section geometry, lateral restraint concept, torsion, deflection, and load path"
status: outline
publication_date: "2025-11-27"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: HP-07
primary_intent: "Memahami structural behavior"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/lentur-dan-torsi-pada-hollow.html"
...
# Lentur dan Torsi pada Hollow: Memahami Arah Kuat, Bentuk, dan Jalur Beban

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lentur dan Torsi pada Hollow: Memahami Arah Kuat, Bentuk, dan Jalur Beban”
- **Reader and situation:** Designer/fabricator membandingkan orientation
- **Reader outcome:** Menjelaskan principal axes, section geometry, lateral restraint concept, torsion, deflection, and load path
- **Primary intent:** Memahami structural behavior
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak menghitung section capacity or deflection; engineer owns project calculation
- **Final public route:** `/artikel/lentur-dan-torsi-pada-hollow.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lentur dan Torsi pada Hollow: Memahami Arah Kuat, Bentuk, dan Jalur Beban**.
...
- `HP-07-01` → `/artikel/data-desain-struktur-hollow.html` — Checklist Data Desain Struktur Hollow Sebelum Memilih Ukuran
- `HP-07-02` → `/artikel/buckling-pada-batang-hollow.html` — Tekan dan Buckling pada Hollow: Mengapa Luas Penampang Saja Tidak Cukup
- `HP-07-04` → `/artikel/pengaruh-sambungan-pada-struktur-hollow.html` — Sambungan Dapat Mengubah Perilaku Struktur Hollow: Enam Pertanyaan untuk Detailer
...
- **Tie back to this article:** Keep the explanation specific to “Lentur dan Torsi pada Hollow: Memahami Arah Kuat, Bentuk, dan Jalur Beban”.

---
article_id: HP-04-04
title: "Sifat Mekanik Pipa dan Hollow Baja Karbon: Yield, Tensile, Elongation, dan Toughness"
slug: "sifat-mekanik-pipa-dan-hollow-baja"
description: "Menjelaskan arti properti, metode bukti, orientasi/specimen context, dan mengapa satu nilai tidak cukup untuk desain"
status: outline
publication_date: "2025-09-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: HP-04
primary_intent: "Memahami data mekanik"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/sifat-mekanik-pipa-dan-hollow-baja.html"
...
# Sifat Mekanik Pipa dan Hollow Baja Karbon: Yield, Tensile, Elongation, dan Toughness

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sifat Mekanik Pipa dan Hollow Baja Karbon: Yield, Tensile, Elongation, dan Toughness”
- **Reader and situation:** Designer/buyer membaca datasheet atau MTC
- **Reader outcome:** Menjelaskan arti properti, metode bukti, orientasi/specimen context, dan mengapa satu nilai tidak cukup untuk desain
- **Primary intent:** Memahami data mekanik
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak memberi allowable stress atau kapasitas; HP-07 memiliki design literacy dan kode proyek memiliki nilai desain
- **Final public route:** `/artikel/sifat-mekanik-pipa-dan-hollow-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sifat Mekanik Pipa dan Hollow Baja Karbon: Yield, Tensile, Elongation, dan Toughness**.
...
- **Tie back to this article:** Keep the explanation specific to “Sifat Mekanik Pipa dan Hollow Baja Karbon: Yield, Tensile, Elongation, dan Toughness”.

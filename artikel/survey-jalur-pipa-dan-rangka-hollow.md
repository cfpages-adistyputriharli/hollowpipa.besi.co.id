---
article_id: HP-11-01
title: "Survey Jalur Pipa dan Rangka Hollow Sebelum Shop Drawing"
slug: "survey-jalur-pipa-dan-rangka-hollow"
description: "Captures geometry, levels, structure, access, obstructions, utilities, environment, lifting route, work restrictions, and evidence gaps"
status: outline
...
final_route: "/artikel/survey-jalur-pipa-dan-rangka-hollow.html"
...
# Survey Jalur Pipa dan Rangka Hollow Sebelum Shop Drawing

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survey Jalur Pipa dan Rangka Hollow Sebelum Shop Drawing”
- **Reader and situation:** Retrofit/new-build team validates real interfaces
- **Reader outcome:** Captures geometry, levels, structure, access, obstructions, utilities, environment, lifting route, work restrictions, and evidence gaps
- **Primary intent:** Plan site survey
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Tidak creates final routing or structural approval; designer/engineer and HP-11-05 own coordinated details
- **Final public route:** `/artikel/survey-jalur-pipa-dan-rangka-hollow.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survey Jalur Pipa dan Rangka Hollow Sebelum Shop Drawing**.
...
- **Exact Markdown to insert:** `![Ilustrasi rangka pipa](/wp-content/uploads/2024/07/rangka-pipa.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `rangka pipa` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Survey Jalur Pipa dan Rangka Hollow Sebelum Shop Drawing”.
